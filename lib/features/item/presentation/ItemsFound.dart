...
class ItemFound extends ConsumerWidget {
  const ItemFound({Key? key}) : super(key: key);
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: itemNotifier.todayFoundItems.length,
                          itemBuilder: (context, index) {
                            return _buildTodayItem(
                              context,
                              itemNotifier.todayFoundItems[index],
                            );
                          },
                        ),
                      ),
                      ...
                      ListView.builder(
                        ...
                        itemCount: itemNotifier.lastSevenDaysFoundItems.length,
                        itemBuilder: (context, index) {
                          return _buildLastSevenDaysItem(
                            context,
                            itemNotifier.lastSevenDaysFoundItems[index],
                          );
                        },
                      ),
                    ],
